...
export const FAQ_Object = [
  {
    ...
    answer: [
      "Сроковете за виждане на резултати зависят от множество фактори, включително обхвата на кампаниите, конкуренцията във вашата ниша, бюджета и др. Обикновено, първите резултати могат да бъдат видими в рамките на няколко седмици, но пълните резултати изискват по-дългосрочен период от време.",
    ],
  },
  {
    id: 2,
    ...
    answer: [
      "Ние предлагаме гъвкави ценови пакети, които могат да бъдат пригодени спрямо нуждите и бюджета на всеки клиент. Цените се определят в зависимост от обхвата на услугите, които се изискват, и други фактори. Ние сме отворени за разговор и готови да работим с различни бюджети.",
    ],
  },
  {
    id: 3,
    ...
    answer: [
      "Обичайният процес включва срещи и консултации с клиента, определяне на целите и стратегията, изпълнение на маркетинговите кампании, непрекъснат мониторинг и оптимизация на резултатите, както и редовна отчетност и обратна връзка.",
    ],
  },
  {
    id: 4,
